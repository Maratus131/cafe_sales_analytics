...
## Что демонстрирует проект для позиции SQL-аналитика

- Умение проектировать нормализованную модель данных.
- Владение DDL, PK/FK, `CHECK`, `DEFAULT`, `NOT NULL`.
- Навыки построения витрин и аналитических SQL-запросов.
- Практику оконных функций и CTE.
- Анализ продаж, клиентской активности, ассортимента и промо-кампаний.
- Оптимизацию через индексы по ключевым полям.
- Интеграцию SQL Server с Python для отчетности.
